...
public class CalculoTipoDTest {
	...
	public void TestaSeCalculoDCOmValorAteVinteECincoMilEstaCorreto() {
		...
		Transferencia transferencia = TransferenciaBuilderParaTeste.buildTransferencia(
				new BigDecimal("23500"), "19/10/2015",
	...
	public void TestaSeCalculoDCOmValorAteCentoEVinteMilEstaCorreto() {
		...
		Transferencia transferencia = TransferenciaBuilderParaTeste.buildTransferencia(
				new BigDecimal("25001"), "19/10/2015",
				TipoTransferenciaEnum.TIPOD);		
		...
		Transferencia transferencia2 = TransferenciaBuilderParaTeste.buildTransferencia(
				new BigDecimal("120000"), "19/11/2015",
				TipoTransferenciaEnum.TIPOD);		
	...
	public void TestaSeCalculoDCOmValorMaiorQueCentoEVinteMilEstaCorreto() {
		...
		Transferencia transferencia3 = TransferenciaBuilderParaTeste.buildTransferencia(
		...
		Transferencia transferencia4 = TransferenciaBuilderParaTeste.buildTransferencia(
		...
		Transferencia transferencia5 = TransferenciaBuilderParaTeste.buildTransferencia(
		...
		Transferencia transferencia6 = TransferenciaBuilderParaTeste.buildTransferencia(
		...
		Transferencia transferencia7 = TransferenciaBuilderParaTeste.buildTransferencia(
